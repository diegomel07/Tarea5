...
public class DeTierra extends Animal {
    ...
    public DeTierra(int precio, int id, String descripcion, String nombre, Date fechaExpedicion, String fabricante,
    ...
    public String toString() {
        return "DeTierra [cant_aletas=" + cant_aletas + ", profundidad=" + profundidad + ", tipo_agua=" + tipo_agua
                + "]";
    }
